...
using Law_Hub.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //var Find the User details from the database
                    //var search = _db.User_Profile_Controller.Find(_userManager.GetUserId(User));


                    if (user != null)
                    {
                        var isInRoleLaw = await _userManager.IsInRoleAsync(user, "Lawyers");
                        var isInRoleClient = await _userManager.IsInRoleAsync(user, "Clients");
                        var IsinRoleAdmin = await _userManager.IsInRoleAsync(user, "Admin");
                        if (isInRoleLaw)
                        {

                            return RedirectToAction("Index", "Lawyer");
                        }
                        else if (isInRoleClient)
                        {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //How to add a new role to the role table
                    //string[] roles = { "Admin", "Lawyers", "Clients", "NotloggedIn" };
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, "Lawyers");
                        ...
                        _db.SaveChanges();
                        return RedirectToAction("CreateProfile", "Lawyer");
                    }
